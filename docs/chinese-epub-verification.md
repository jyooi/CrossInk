...
| 6 | Settings, Reader, Text Anti-Aliasing off | Setting takes effect immediately | Holistic pass, 2026-08-24 (see notes below) |
| 7 | 20 page turns, Text Anti-Aliasing off | Every page renders, turns are faster than step 4 | Holistic pass, 2026-08-24 (see notes below) |
...
| 13 | Start Wi-Fi file transfer, then exit | Web portal opens; after exit the CJK UI fallback still shows Chinese titles without a restart | Holistic pass, 2026-08-24 (see notes below) |
...
The checklist table above marks the non-heap rows as a holistic pass from
this report. Steps 3, 5, 8, 12, and 14 stay pending, because the captain did
not capture heap figures. The known unmeasured risk section above is still
open: the 4-style advance-cache aggregate and the transient merge peak still
have no device measurement.
